...
%objetivoFinal = [42, 28]; %test12 WIN
objetivoFinal = [42, 28]; %test13 obstaculo en (14,6) WIN con atrapado!
...
tiempoUmbral = 30; % Tiempo máximo en iteraciones del bucle principal para moverse distanciaUmbral
